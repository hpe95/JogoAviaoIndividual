...
bool Game::init(const char* title, int xpos, int ypos, int width, int height, bool fullscreen){
	...
	GameObjectFactory::Instance().registerType("EnemyShooter1", new EnemyShooter1Creator());
	GameObjectFactory::Instance().registerType("EnemyShooter2", new EnemyShooter2Creator());
